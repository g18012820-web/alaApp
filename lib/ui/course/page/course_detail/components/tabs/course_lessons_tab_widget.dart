          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: OutlinedButton.icon(
                onPressed: () => AutoRouter.of(context).push(StudentQuizListRoute(courseId: course.id, courseName: course.title)),
                icon: const Icon(Icons.quiz_outlined),
                label: const Text('اختبارات الدورة'),
              ),
            ),
          ),
          Expanded(
                ...
                return LessonItemWidget(
                  onTap: () {
                    AutoRouter.of(context).push(LessonVideoPlayerRoute(
                      videoUrl: item.videoUrl.isNotEmpty ? item.videoUrl : 'https://flutter.github.io/assets-for-api-docs/assets/videos/bee.mp4',
                      title: item.title,
                      lessonId: item.id,
                    ));
                  },
