...
class CourseEntity {
  ...
  /// معرّف المادة التي تتبع لها الدورة (راجع القسم 3: المواد الدراسية)
  final String subjectId;

  /// عدد الحصص داخل الدورة
  final int lessonsCount;

  /// حالة الدورة التي يتحكم بها المالك (بيع/إيقاف/إخفاء...)
  final CourseStatus status;

  /// صورة الغلاف (بانر) الخاصة بالدورة، منفصلة عن الصورة المصغرة
  ...
  CourseEntity({
    ...
    this.subjectId = '',
    this.lessonsCount = 0,
    this.status = CourseStatus.saleActive,
    this.coverImage = '',
  });
